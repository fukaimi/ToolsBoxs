<template>
  <div>
    ...
    <div class="baseHeight">
      <a-row>
        <a-col :span="12" style="margin: 0 auto;text-align: center"><vue-qr :text="textCon" :size="size"/></a-col>
        <a-col :span="12">
          <a-slider v-model="size" :default-value="1" :min="200" :max="400" :tooltip-visible="true" />
          <a-textarea v-model="textCon" placeholder="文本内容" :rows="8"/>
        </a-col>
      </a-row>
