...
<script>
import card from "@/views/tools/uichange/ta404/component/card";
import selectdiy from "@/views/tools/uichange/ta404/component/select";
import inputdiy from "@/views/tools/uichange/ta404/component/input";
import datecom from "@/views/tools/uichange/ta404/component/datecom";
import vuetemplate from "@/views/tools/uichange/ta404/component/vuetemplate";
import tablecom from "@/views/tools/uichange/ta404/component/tablecom";
