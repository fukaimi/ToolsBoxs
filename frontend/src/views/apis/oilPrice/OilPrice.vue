    ...
    <a-card title="今日油价" style="background-color:rgba(0,0,0,0.1);border-radius: 1rem">
      ...
      <a-descriptions :title="oilprice.prov">
        <a-descriptions-item label="零号柴油">
          <span :style="oilprice.p0 < 7 ? styleGren : oilprice.p0 > 8 ? styleRed : styleWarn">{{ oilprice.p0 }} 元</span>
        </a-descriptions-item>
        <a-descriptions-item label="89号汽油">
          <span :style="oilprice.p89 < 7 ? styleGren : oilprice.p89 > 8 ? styleRed : styleWarn">{{ oilprice.p89 }} 元</span>
        </a-descriptions-item>
        <a-descriptions-item label="92号汽油">
          <span :style="oilprice.p92 < 7 ? styleGren : oilprice.p92 > 8 ? styleRed : styleWarn">{{ oilprice.p92 }} 元</span>
        </a-descriptions-item>
        <a-descriptions-item label="95号汽油">
          <span :style="oilprice.p95 < 7 ? styleGren : oilprice.p95 > 8 ? styleRed : styleWarn">{{ oilprice.p95 }} 元</span>
        </a-descriptions-item>
